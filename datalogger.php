...
#Draw a rectangle
ImageFilledRectangle($image, 0, 0, 400, 400, $grey); 
...
$xincrement = bcdiv(400, $num_rows-1,0);
$x=0;
$i=0;
...
for($i=0;$i<$num_rows-1;$i++){
	#var_dump($points[$i][0]);
	#var_dump($points[$i][1]);
	$error = ImageLine($image,$points[$i][0],400-$points[$i][1],$points[$i+1][0],400-$points[$i+1][1],$red);
